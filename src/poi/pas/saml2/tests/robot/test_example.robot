...
#
#  $ bin/test -s poi.pas.saml2 -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src poi.pas.saml2.testing.POI_PAS_SAML2_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/poi/pas/saml2/tests/robot/test_example.robot
#
